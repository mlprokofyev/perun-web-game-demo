...
export function generateWorld(): TileMap {
  ...
  // 3 trees (repositioned for 6×6 grid)
   tileMap.addObject({ col: 0.7,   row: 4.7, assetId: 'obj_tree_snow', width: 438, height: 600, srcW: 511, srcH: 700, anchorY: 0.92, solid: true, solidCols: 0.9, solidRows: 0.9, shadowRadius: 35 });
  tileMap.addObject({ col: 3.5, row: 1,   assetId: 'obj_tree2', width: 438, height: 600, srcW: 511, srcH: 700, anchorY: 0.92, solid: true, solidCols: 0.9, solidRows: 0.9, shadowRadius: 45 });
  tileMap.addObject({ col: 5,   row: 3.5, assetId: 'obj_tree_snow', width: 438, height: 600, srcW: 511, srcH: 700, anchorY: 0.92, solid: true, solidCols: 0.9, solidRows: 0.9, shadowRadius: 35 });
